...
Funding Organizer is an Understrap child theme. It was built on Pantheon. 

The /root directory includes custom files that are needed in the root of the application. 
